// RUN: r1cs-opt %s 2>&1 | FileCheck --dump-input=always --enable-var-scope %s
...
// CHECK-SAME:                                        %[[VAL_0:.*]]: !r1cs.signal {#r1cs.pub},
// CHECK-SAME:                                        %[[VAL_1:.*]]: !r1cs.signal,
// CHECK-SAME:                                        %[[VAL_2:.*]]: !r1cs.signal) {
// CHECK:           %[[VAL_3:.*]] = r1cs.def 0 : !r1cs.signal {pub = #r1cs.pub}
// CHECK:           %[[VAL_4:.*]] = r1cs.def 1 : !r1cs.signal
// CHECK:           %[[VAL_5:.*]] = r1cs.def 2 : !r1cs.signal
// CHECK:           %[[VAL_6:.*]] = r1cs.to_linear %[[VAL_1]] : !r1cs.signal to !r1cs.linear
// CHECK:           %[[VAL_7:.*]] = r1cs.to_linear %[[VAL_2]] : !r1cs.signal to !r1cs.linear
// CHECK:           %[[VAL_8:.*]] = r1cs.to_linear %[[VAL_4]] : !r1cs.signal to !r1cs.linear
// CHECK:           %[[VAL_9:.*]] = r1cs.mul_const %[[VAL_8]],  -1 : i64 : !r1cs.linear
// CHECK:           r1cs.constrain %[[VAL_6]], %[[VAL_7]], %[[VAL_9]] : !r1cs.linear
// CHECK:           %[[VAL_10:.*]] = r1cs.to_linear %[[VAL_0]] : !r1cs.signal to !r1cs.linear
// CHECK:           %[[VAL_11:.*]] = r1cs.to_linear %[[VAL_5]] : !r1cs.signal to !r1cs.linear
// CHECK:           %[[VAL_12:.*]] = r1cs.mul_const %[[VAL_11]],  -1 : i64 : !r1cs.linear
// CHECK:           %[[VAL_13:.*]] = r1cs.add %[[VAL_9]], %[[VAL_12]] : !r1cs.linear
// CHECK:           r1cs.constrain %[[VAL_10]], %[[VAL_6]], %[[VAL_13]] : !r1cs.linear
// CHECK:           r1cs.constrain %[[VAL_10]], %[[VAL_6]], %[[VAL_12]] : !r1cs.linear
// CHECK:           %[[VAL_14:.*]] = r1cs.to_linear %[[VAL_3]] : !r1cs.signal to !r1cs.linear
// CHECK:           %[[VAL_15:.*]] = r1cs.mul_const %[[VAL_14]],  -1 : i64 : !r1cs.linear
// CHECK:           %[[VAL_16:.*]] = r1cs.mul_const %[[VAL_6]],  -1 : i64 : !r1cs.linear
// CHECK:           %[[VAL_17:.*]] = r1cs.add %[[VAL_15]], %[[VAL_16]] : !r1cs.linear
