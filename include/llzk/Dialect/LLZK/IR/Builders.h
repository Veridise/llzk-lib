...
public:
  ...
  inline mlir::FailureOr<function::FuncDefOp> getComputeFn(llzk::StructDefOp op) const {
  ...
  inline mlir::FailureOr<function::FuncDefOp> getConstrainFn(llzk::StructDefOp op) {
