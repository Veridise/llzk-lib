...
#define LLZK_BUILD_METHOD_NAME(op, name) llzk##op##Build##name
#define LLZK_DECLARE_OP_BUILD_METHOD(op, name, ...)                                                \
  MLIR_CAPI_EXPORTED MlirOperation LLZK_BUILD_METHOD_NAME(op, name)(                               \
